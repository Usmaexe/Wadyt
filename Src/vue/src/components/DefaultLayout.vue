        ...
        <div class="flex h-16 items-center justify-between">
          <div class="flex items-center">
            <div class="flex-shrink-0">
              <img class="h-12 w-12" src="../assets/Logo.png" alt="Your Company" />
            </div>
              ...
              <Menu as="div" class="relative ml-3">
                <div>
                  <MenuButton class="flex max-w-xs items-center rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
                    ...
                    <img class="h-8 w-8 rounded-full" :src="store.state.user.data.imageUrl" alt="" />
                  </MenuButton>
                </div>
        ...
        <div class="border-t border-gray-700 pb-3 pt-4">
          <div class="flex items-center px-5">
            ...
            <div class="ml-3">
              ...
              <div class="text-sm font-medium leading-none text-gray-400">{{ store.state.user.data.email }}</div>
            </div>
          </div>
          <div class="mt-3 space-y-1 px-2">
            ...
            hover:text-white cursor-pointer">Sign out</DisclosureButton>
          </div>
        </div>
      </DisclosurePanel>
    </Disclosure>
